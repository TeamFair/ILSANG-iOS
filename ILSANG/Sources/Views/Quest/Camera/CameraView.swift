...
#Preview {
    CameraView(submitViewModel: SubmitRouterViewModel(selectedQuest: .mockData, submitService: ImageChallengeSubmitService(imageNetwork: ImageNetwork(), challengeNetwork: ChallengeNetwork())))
}
